...
if scenario_num <= 4 && train==true
    nhname = sprintf('maps\\map_0%d_nh.png',scenario_num); %Image no hazards
    yhname = sprintf('maps\\map_0%d_nh.png',scenario_num); %Image with hazards (hidded for training)
    dtname = sprintf('maps\\map_0%d_data.mat',scenario_num); %Map Data
    hsname = sprintf('maps\\blank_hsi_map.png'); %HSI map
elseif scenario_num < 10 && train==true
    nhname = sprintf('maps\\map_0%d_nh.png',scenario_num); %Image no hazards
    yhname = sprintf('maps\\map_0%d_yh.png',scenario_num); %Image with hazards
    dtname = sprintf('maps\\map_0%d_data.mat',scenario_num); %Map Data
    hsname = sprintf('maps\\map_0%d_haz.png',scenario_num); %HSI map
elseif scenario_num < 13 && train==true
    nhname = sprintf('maps\\map_%d_nh.png',scenario_num); %Image no hazards
    yhname = sprintf('maps\\map_%d_yh.png',scenario_num); %Image with hazards
    dtname = sprintf('maps\\map_%d_data.mat',scenario_num); %Map Data
    hsname = sprintf('maps\\map_%d_haz.png',scenario_num); %HSI map
else
end 
